...
. *Optional:* You can specify multiple SSH public keys, which enable you and your team members to access the hosts after those are installed.

+
[source,yaml]
----
sshKey: |
  ssh-rsa <1st-public-key-here>
  ssh-rsa <2nd-public-key-here>
  ssh-rsa <3rd-public-key-here>
----
